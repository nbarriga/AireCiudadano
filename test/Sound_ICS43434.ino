/*
 * A-weighted sound level measured by I2S Microphone
 * 
...
#define MIC_NOISE_DB      29          // dB - Equivalent input noise
...
//
#define I2S_WS   19    // MHT BOARD
#define I2S_SCK  22    // MHT BOARD 
#define I2S_SD   21    // MHT BOARD 

#define PINTX  17      // MHT BOARD 

//#define I2S_WS   27      // COBOGSML 01
//#define I2S_SCK  25      // COBOGSML 01
//#define I2S_SD   26      // COBOGSML 01
 
//#define PINTX  13        //COBOGSML 01
...
const SOS_Coefficients dc_blocker_coeffs[] = {
  {-1.0, 0.0, +0.9992, 0}
};
SOS_IIR_Filter DC_BLOCKER(1.0f, dc_blocker_coeffs);
...
const SOS_Coefficients ics43434_coeffs[] = {
...
SOS_IIR_Filter ICS43434(0.477326418836803f, ics43434_coeffs);
...
const SOS_Coefficients ics43432_coeffs[] = {
...
SOS_IIR_Filter ICS43432(-0.457337023383413f, ics43432_coeffs);
...
const SOS_Coefficients inmp441_coeffs[] = {
  {-1.986920458344451, +0.986963226946616, +1.995178510504166, -0.995184322194091}
};
SOS_IIR_Filter INMP441(1.00197834654696f, inmp441_coeffs);
...
const SOS_Coefficients im69d130_coeffs[] = {
  {-1.0, 0.0, +0.9992, 0},
  {-1.994461610298131, 0.994469278738208, +1.997675693595542, -0.997677044195563}
};
SOS_IIR_Filter IM69D130(1.00124068496753f, im69d130_coeffs);
...
// With additional DC blocking component
const SOS_Coefficients sph0645_coeffs[] = {
  {-1.0, 0.0, +0.9992, 0},
  {-1.988897663539382, +0.988928479008099, +1.993853376183491, -0.993862821429572}
};
SOS_IIR_Filter SPH0645LM4H_B_RB(1.00123377961525f, sph0645_coeffs);
...
const SOS_Coefficients a_weighting_coeffs[] = {
  {-2.00026996133106, +1.00027056142719, -1.060868438509278, -0.163987445885926},
  {+4.35912384203144, +3.09120265783884, +1.208419926363593, -0.273166998428332},
  {-0.70930303489759, -0.29071868393580, +1.982242159753048, -0.982298594928989}
};
SOS_IIR_Filter A_weighting(0.169994948147430f, a_weighting_coeffs);
...
const SOS_Coefficients c_weighting_coeffs[] = {
...
SOS_IIR_Filter C_weighting(-0.491647169337140f, c_weighting_coeffs);
...
void mic_i2s_init() {
  ...
  const i2s_config_t i2s_config = {
    ...
    channel_format: I2S_CHANNEL_FMT_ONLY_LEFT,  // Bug in Arduino_esp32 1.0.3, use I2S_CHANNEL_FMT_ONLY_RIGHT if you update to that version 
...
//  setCpuFrequencyMhz(80); // It should run as low as 80MHz
  ...
  Serial.begin(115200);
  Serial2.begin(9600, SERIAL_8N1, 16, PINTX);
  pinMode(2, OUTPUT);
  Serial.println("ICS43434 A_weighting: dBA measurement ");
  delay(1000); // Safety
